#ideas that are on/beyond the boarder of this project go here, these are in no particular order and are extra bits for after the core functions are done
